---
name: wizard
description: Generate an interactive bash wizard for steps only a human can perform. Use when provisioning infrastructure, setting up credentials or CI secrets, navigating a third-party dashboard, or running a one-off migration or cutover. Not for steps the agent can do itself.
---
