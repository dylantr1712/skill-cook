---
name: i-have-adhd
description: 'Shape output for a reader with ADHD: answer first, number multi-step work, restate state across turns, cut filler, make wins visible. Stays on until "stop adhd mode".'
